...
const Nav = ({ authToken, setShowBoarding, showBoarding, setSignUp }) => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark">
            <a className="navbar-brand" href="/">FAITH <span id="nav-title-acronym"> Fully Accessible Intelligent Tool for Health</span></a>
            ...
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div className="navbar-nav">
                    ...
                    {authToken && <><NavLink to="/trainingvideos" className="nav-item nav-link">Training Videos</NavLink> <span>|</span></>}
                    <NavLink to="/help" className="nav-item nav-link">Help?</NavLink> <span>|</span>
                    {/* log in button */}
                    {!authToken && <button
                    ...
                    {/* logged in */}
                    {authToken && <>
                        <NavLink to="/myaccount" className="nav-item nav-link">Account<i className="fa-regular fa-user fa icon"></i></NavLink>
